...
<!--								<p><strong>Last Login:</strong> $last_login</p>-->
		...
		<?php
			if(isset($_POST['update']))
			{
				...
				$update = "update users set user_name='$u_name',user_pass='$user_pass',user_email='$user_email',user_country='$u_country',user_image='$u_image', user_birthday='$u_birthday' where user_id='$user_id'";
